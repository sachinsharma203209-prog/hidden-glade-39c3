...
(1, (SELECT id FROM attributes WHERE slug='post'), 'font-changer/post', 'attribute',
 ...
 'Post Font Generator',
 'The Font Changer helps you create stylish text for social media posts. Type your post text and copy bold, fancy, cursive, and cool Unicode font styles for any social media platform.',
 1, 'index,follow', 'published');
